...
namespace Saffron\Testimonial\Model;

class Testimo extends \Magento\Framework\Model\AbstractModel {
	const STATUS_ENABLED = 1;
	const STATUS_DISABLED = 2;
	const BASE_MEDIA_PATH = 'Saffron/testimonial/images';
	...
	public function __construct(
		...
		\Saffron\Testimonial\Model\ResourceModel\Testimo $resource,
		\Saffron\Testimonial\Model\ResourceModel\Testimo\Collection $resourceCollection,
