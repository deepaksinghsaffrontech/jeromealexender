...
class Testimoniallist extends \Magento\Framework\View\Element\Template
{
    ...
    public function __construct(
        ...
        \Saffron\Testimonial\Model\TestimoFactory $testimonialFactory,
    ...
    protected function _prepareLayout()
    {
        ...
        if ($this->getCollection()) {
            ...
            $pager = $this->getLayout()->createBlock(
                ...
                'Saffron.testimonial.record.pager'
            );
    ...
    {
        return $this->getViewFileUrl('Saffron_testimonial::images/default.jpg');
    }
